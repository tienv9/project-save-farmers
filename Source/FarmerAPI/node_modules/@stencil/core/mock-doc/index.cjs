/*!
 Stencil Mock Doc (CommonJS) v4.26.0 | MIT Licensed | https://stenciljs.com
 */
"use strict";
...
var mock_doc_exports = {};
__export(mock_doc_exports, {
  MockAttr: () => MockAttr,
...
module.exports = __toCommonJS(mock_doc_exports);
